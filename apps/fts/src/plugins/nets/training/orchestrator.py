...
def train_and_register_candidate(
    ...
    model_params_with_base = model_params.copy()
    model_params_with_base["feature_cols"] = feature_cols
    model_params_with_base["lookback_period"] = lookback_period
    model_config_obj = config_cls(**model_params_with_base)
