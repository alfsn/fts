...
class MarketDetails(BaseModel):
    ...
    end_date: Optional[datetime] = Field(
        None, description="The timestamp when the market is scheduled to resolve."
    )
    ...
    asset_type: Optional[str] = Field(
        None, description="The type of asset (e.g., 'equity', 'crypto')."
    )
    geography: Optional[str] = Field(None, description="The geography of the asset.")
    currency: Optional[str] = Field("USD", description="The currency of the asset.")
...
class PortfolioState(BaseModel):
    ...
    cash_balances: Dict[str, float] = Field(
        default_factory=dict, description="Multi-currency cash balances."
    )
